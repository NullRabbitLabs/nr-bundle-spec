...
<!-- nr-bundle-count: 910 -->
<!-- nr-chains: aptos,bitcoin,bnb-smart-chain,cardano,casper,celestia,conflux,cosmos,dogecoin,ethereum,ethereum-consensus-layer,filecoin,http2,http3,ic,icon,iota,ipfs,kaspa,libp2p,litecoin,monero,optimism,polkadot,polkadot-substrate,polygon-pos,qtum,quic,solana,solana-agave,sonic-fantom,sui,walrus,xrp,zcash -->
...
A curated, multi-modal dataset of blockchain validator infrastructure under attack and benign workloads. **910 bundles** across **35 chains and network stacks** (Aptos, Bitcoin, bnb-smart-chain, Cardano, casper, celestia, conflux, Cosmos, Dogecoin, Ethereum, ethereum-consensus-layer, Filecoin, http2, http3, ic, icon, IOTA, ipfs, kaspa, libp2p, Litecoin, Monero, optimism, polkadot, polkadot-substrate, polygon-pos, qtum, quic, Solana, Solana (Agave), sonic-fantom, Sui, walrus, XRP, zcash), all thirteen families in the taxonomy (twelve attack classes plus `benign`), and **195 attack primitive_ids** — including faithful wire-level reproductions of **148 publicly disclosed CVEs and security advisories** in blockchain node software. Released as the public sample of NullRabbit's bundle corpus, which underpins [NullRabbit Labs'](https://huggingface.co/NullRabbit) ML research on autonomous defence for decentralised networks.
<!-- AUTO:headline:END -->
